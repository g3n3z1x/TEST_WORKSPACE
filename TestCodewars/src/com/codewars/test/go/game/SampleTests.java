...
public class SampleTests {
	...
	@Test
	public void test_CreatingGoBoards_OneArg() {
	...
	public void test_PlacingStones_StonesReproduction() {
		...
		g.move(coords);
		for (String pos : coords) {
			String msg = "Cannot place a stone on an existing stone. Should throw an IllegalArgumentExcpetion: " + pos + " is an invalid move";
			try {
				g.move(pos);
				fail(msg);
	...
	private static Map<String, String[][]> VALID_CAPTURE_DATAS = new HashMap<String, String[][]>() {
		{
			...
			put("Black captures single white stone", new String[][] { { "4D", "3D", "4H", "5D", "3H", "4C", "5B", "4E" }, { "4D" } });

			put("Black captures multiple white stones",
					new String[][] {
							{ "6D", "7E", "6E", "6F", "4D", "5E", "5D", "7D", "5C", "6C", "7H", "3D", "4E", "4F", "3E", "2E", "3F", "3G", "2F", "1F", "2G",
									"2H", "1G", "1H", "4C", "3C", "6H", "4B", "5H", "5B" },
							{ "6D", "6E", "4D", "5D", "5C", "4E", "3E", "3F", "2F", "2G", "1G", "4C" } });

			put("Corner capture", new String[][] { { "9A", "8A", "8B", "9B" }, { "9A" } });

			put("Multiple captures", new String[][] { { "5D", "5E", "4E", "6E", "7D", "4F", "7E", "3E", "5F", "4D", "6F", "6D", "6C", "7F", "4E", "5E" },
					{ "4E", "6D", "6E" } });

			put("Snapback",
					new String[][] {
							{ "5A", "1E", "5B", "2D", "5C", "2C", "3A", "1C", "2A", "3D", "2B", "3E", "4D", "4B", "4E", "4A", "3C", "3B", "1A", "4C", "3C" },
							{ "4A", "4B", "4C", "3B" } });
		}
	};
	...
	@Test
	public void test_HandicapStones() {
